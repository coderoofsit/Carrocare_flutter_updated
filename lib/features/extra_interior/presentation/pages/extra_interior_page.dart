                ...
                children: <Widget>[
                  Positioned.fill(
                    child: Container(
                      ...
                      child: BlocBuilder<ExtraInteriorBloc, ExtraInteriorState>(
                        builder: (context, state) {
                          if (state is ExtraInteriorLoading ||
                              state is ExtraInteriorInitial) {
                            return const Center(
                  ...
                  Align(
                    ...
                    child: BlocBuilder<ExtraInteriorBloc, ExtraInteriorState>(
                      builder: (context, state) {
                        final price = state is ExtraInteriorLoaded
